...
import {
    clamp, bindEvents, unbindEvents, preventDefault, getCID, vInit, normalizeDirection
} from '../utils/util.js';
...
const data = shallowReactive({
    ...
    sizeKey: normalizeDirection(props.direction) === 'row' ? 'offsetWidth' : 'offsetHeight',
    clientKey: normalizeDirection(props.direction) === 'row' ? 'clientWidth' : 'clientHeight',
    offsetKey: normalizeDirection(props.direction) === 'row' ? 'offsetX' : 'offsetY',
